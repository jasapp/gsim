...
gsim.number.full_format_QMARK_ = function full_format_QMARK_(num) {
  var and__3822__auto____6877 = cljs.core.not.call(null, gsim.number.decimal_QMARK_.call(null, num));
...
gsim.number.no_leading_QMARK_ = function no_leading_QMARK_(num) {
  var num_str__6880 = [cljs.core.str(num)].join("");
  var and__3822__auto____6881 = cljs.core.count.call(null, num_str__6880) < gsim.number.number_length;
  if(and__3822__auto____6881) {
    return cljs.core.not.call(null, cljs.core.re_find.call(null, /^0/, num_str__6880))
  }else {
    return and__3822__auto____6881
  }
};
gsim.number.no_trailing_QMARK_ = function no_trailing_QMARK_(num) {
  var num_str__6884 = [cljs.core.str(num)].join("");
  var and__3822__auto____6885 = cljs.core.count.call(null, num_str__6884) < gsim.number.number_length;
  if(and__3822__auto____6885) {
    return cljs.core.not.call(null, cljs.core.re_find.call(null, /0$/, num_str__6884))
  }else {
...
gsim.number.format_multiplier = function format_multiplier(num, system) {
  ...
  var multipliers__6888 = cljs.core.ObjMap.fromObject(["\ufdd0'metric", "\ufdd0'imperial"], {"\ufdd0'metric":cljs.core.ObjMap.fromObject(["\ufdd0'full", "\ufdd0'no-leading", "\ufdd0'no-trailing"], {"\ufdd0'full":0.0010, "\ufdd0'no-leading":0.0010, "\ufdd0'no-trailing":0.01}), "\ufdd0'imperial":cljs.core.ObjMap.fromObject(["\ufdd0'full", "\ufdd0'no-leading", "\ufdd0'no-trailing"], {"\ufdd0'full":1.0E-4, "\ufdd0'no-leading":1.0E-4, "\ufdd0'no-trailing":0.01})});
  var number_format__6889 = cljs.core.truth_(gsim.number.full_format_QMARK_.call(null, num)) ? "\ufdd0'full" : cljs.core.truth_(gsim.number.no_leading_QMARK_.call(null, num)) ? "\ufdd0'no-leading" : cljs.core.truth_(gsim.number.no_trailing_QMARK_.call(null, num)) ? "\ufdd0'no-trailing" : null;
  if(cljs.core.keyword_QMARK_.call(null, number_format__6889)) {
  }else {
  ...
  return number_format__6889.call(null, system.call(null, multipliers__6888))
};
gsim.number.parse_dimensional_number = function parse_dimensional_number(num, system) {
  if(cljs.core.truth_(function() {
    var or__3824__auto____6894 = cljs.core._EQ_.call(null, "0", num);
    ...
    var n__6895 = parseInt(num, 10);
    var multiplier__6896 = gsim.number.format_multiplier.call(null, num, system);
    if(cljs.core.truth_(function() {
      var and__3822__auto____6897 = cljs.core.not.call(null, isNaN(n__6895));
      if(and__3822__auto____6897) {
        return multiplier__6896
      }else {
        return and__3822__auto____6897
      }
    }())) {
    }else {
      throw new Error([cljs.core.str("Assert failed: "), cljs.core.str([cljs.core.str("Not a number: "), cljs.core.str(n__6895)].join("")), cljs.core.str("\n"), cljs.core.str(cljs.core.pr_str.call(null, cljs.core.with_meta(cljs.core.list("\ufdd1'and", cljs.core.with_meta(cljs.core.list("\ufdd1'not", cljs.core.with_meta(cljs.core.list("\ufdd1'js/isNaN", "\ufdd1'n"), cljs.core.hash_map("\ufdd0'line", 55))), cljs.core.hash_map("\ufdd0'line", 55)), "\ufdd1'multiplier"), cljs.core.hash_map("\ufdd0'line", 
      55))))].join(""));
    }
    return n__6895 * multiplier__6896
  }
};
...
gsim.number.parse_number = function parse_number(num) {
  var n__6899 = parseInt(num, 10);
  if(cljs.core.not.call(null, isNaN(n__6899))) {
  }else {
...
clojure.string.split = function() {
  ...
  var split__3 = function(s, re, limit) {
    if(limit < 1) {
      ...
      var s__6906 = s;
      var limit__6907 = limit;
      var parts__6908 = cljs.core.PersistentVector.EMPTY;
      while(true) {
        if(cljs.core._EQ_.call(null, limit__6907, 1)) {
          return cljs.core.conj.call(null, parts__6908, s__6906)
        }else {
          var temp__3971__auto____6909 = cljs.core.re_find.call(null, re, s__6906);
          if(cljs.core.truth_(temp__3971__auto____6909)) {
            var m__6910 = temp__3971__auto____6909;
            var index__6911 = s__6906.indexOf(m__6910);
            var G__6912 = s__6906.substring(index__6911 + cljs.core.count.call(null, m__6910));
            var G__6913 = limit__6907 - 1;
            var G__6914 = cljs.core.conj.call(null, parts__6908, s__6906.substring(0, index__6911));
            s__6906 = G__6912;
            limit__6907 = G__6913;
            parts__6908 = G__6914;
            continue
...
clojure.string.trim_newline = function trim_newline(s) {
  var index__6918 = s.length;
  while(true) {
    if(index__6918 === 0) {
      return""
    }else {
      var ch__6919 = cljs.core._lookup.call(null, s, index__6918 - 1, null);
      if(function() {
        var or__3824__auto____6920 = cljs.core._EQ_.call(null, ch__6919, "\n");
        if(or__3824__auto____6920) {
          return or__3824__auto____6920
        }else {
          return cljs.core._EQ_.call(null, ch__6919, "\r")
        }
      }()) {
        var G__6921 = index__6918 - 1;
        index__6918 = G__6921;
        continue
      }else {
        return s.substring(0, index__6918)
      }
    }
    break
  }
...
clojure.string.blank_QMARK_ = function blank_QMARK_(s) {
  var s__6925 = [cljs.core.str(s)].join("");
  if(cljs.core.truth_(function() {
    var or__3824__auto____6926 = cljs.core.not.call(null, s__6925);
    if(or__3824__auto____6926) {
      return or__3824__auto____6926
    }else {
      var or__3824__auto____6927 = cljs.core._EQ_.call(null, "", s__6925);
      if(or__3824__auto____6927) {
        return or__3824__auto____6927
      }else {
        return cljs.core.re_matches.call(null, /\s+/, s__6925)
      }
    }
  }())) {
    return true
...
clojure.string.escape = function escape(s, cmap) {
  var buffer__6934 = new goog.string.StringBuffer;
  var length__6935 = s.length;
  var index__6936 = 0;
  while(true) {
    if(cljs.core._EQ_.call(null, length__6935, index__6936)) {
      return buffer__6934.toString()
    }else {
      var ch__6937 = s.charAt(index__6936);
      var temp__3971__auto____6938 = cljs.core._lookup.call(null, cmap, ch__6937, null);
      if(cljs.core.truth_(temp__3971__auto____6938)) {
        var replacement__6939 = temp__3971__auto____6938;
        buffer__6934.append([cljs.core.str(replacement__6939)].join(""))
      }else {
        buffer__6934.append(ch__6937)
      }
      var G__6940 = index__6936 + 1;
      index__6936 = G__6940;
      continue
    }
    break
...
gsim.parse.is_comment_QMARK_ = function is_comment_QMARK_(word_str) {
  var and__3822__auto____6832 = goog.string.startsWith(word_str, "(");
  if(cljs.core.truth_(and__3822__auto____6832)) {
...
gsim.parse.split_comment = function split_comment(gcode_str) {
  var line_after_split__6836 = clojure.string.split.call(null, gcode_str, /(\(.*\))/);
  var gcode__6837 = cljs.core.first.call(null, line_after_split__6836);
  var comment__6838 = 2 <= cljs.core.count.call(null, line_after_split__6836) ? cljs.core.second.call(null, line_after_split__6836) : null;
  return cljs.core.PersistentVector.fromArray([gcode__6837, comment__6838], true)
};
gsim.parse.tokenize_block = function tokenize_block(line_str) {
  var vec__6844__6845 = gsim.parse.split_comment.call(null, line_str);
  var gcode_str__6846 = cljs.core.nth.call(null, vec__6844__6845, 0, null);
  var comment__6847 = cljs.core.nth.call(null, vec__6844__6845, 1, null);
  var tokens__6848 = cljs.core.remove.call(null, clojure.string.blank_QMARK_, clojure.string.split.call(null, gcode_str__6846, /(\D[+-]*\d*\.?\d*)/));
  return cljs.core.PersistentVector.fromArray([tokens__6848, comment__6847], true)
};
...
gsim.parse.parse_word = function() {
  var method_table__2561__auto____6849 = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
  var prefer_table__2562__auto____6850 = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
  var method_cache__2563__auto____6851 = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
  var cached_hierarchy__2564__auto____6852 = cljs.core.atom.call(null, cljs.core.ObjMap.EMPTY);
  var hierarchy__2565__auto____6853 = cljs.core._lookup.call(null, cljs.core.ObjMap.EMPTY, "\ufdd0'hierarchy", cljs.core.global_hierarchy);
  return new cljs.core.MultiFn("parse-word", function(x) {
    var allowed_decimal__6854 = cljs.core.PersistentHashSet.fromArray(["\ufdd0'r", "\ufdd0'z", "\ufdd0'y", "\ufdd0'x", "\ufdd0'a", "\ufdd0'c", "\ufdd0'b", "\ufdd0'f", "\ufdd0'e", "\ufdd0'k", "\ufdd0'j", "\ufdd0'i", "\ufdd0'w", "\ufdd0'u", "\ufdd0'q"]);
    if(cljs.core.contains_QMARK_.call(null, allowed_decimal__6854, cljs.core.keyword.call(null, clojure.string.lower_case.call(null, cljs.core.first.call(null, x))))) {
      return"\ufdd0'decimal"
    }else {
      return null
    }
  }, "\ufdd0'default", hierarchy__2565__auto____6853, method_table__2561__auto____6849, prefer_table__2562__auto____6850, method_cache__2563__auto____6851, cached_hierarchy__2564__auto____6852)
}();
cljs.core._add_method.call(null, gsim.parse.parse_word, "\ufdd0'decimal", function(w) {
  var vec__6855__6856 = gsim.parse.tokenize_word.call(null, w);
  var address__6857 = cljs.core.nth.call(null, vec__6855__6856, 0, null);
  var arg__6858 = cljs.core.nth.call(null, vec__6855__6856, 1, null);
  return cljs.core.ObjMap.fromObject(["\ufdd0'address", "\ufdd0'word", "\ufdd0'metric-arg", "\ufdd0'imperial-arg"], {"\ufdd0'address":address__6857, "\ufdd0'word":w, "\ufdd0'metric-arg":gsim.number.parse_metric.call(null, arg__6858), "\ufdd0'imperial-arg":gsim.number.parse_imperial.call(null, arg__6858)})
});
cljs.core._add_method.call(null, gsim.parse.parse_word, "\ufdd0'default", function(w) {
  var vec__6859__6860 = gsim.parse.tokenize_word.call(null, w);
  var address__6861 = cljs.core.nth.call(null, vec__6859__6860, 0, null);
  var arg__6862 = cljs.core.nth.call(null, vec__6859__6860, 1, null);
  var parsed_arg__6863 = gsim.number.parse_number.call(null, arg__6862);
  return cljs.core.ObjMap.fromObject(["\ufdd0'address", "\ufdd0'word", "\ufdd0'arg"], {"\ufdd0'address":address__6861, "\ufdd0'word":cljs.core.keyword.call(null, [cljs.core.str(cljs.core.name.call(null, address__6861)), cljs.core.str(parsed_arg__6863)].join("")), "\ufdd0'arg":parsed_arg__6863})
});
gsim.parse.parse_block = function parse_block(block_str) {
  var vec__6869__6870 = gsim.parse.tokenize_block.call(null, block_str);
  var words__6871 = cljs.core.nth.call(null, vec__6869__6870, 0, null);
  var comment__6872 = cljs.core.nth.call(null, vec__6869__6870, 1, null);
  var parsed__6873 = cljs.core.map.call(null, gsim.parse.parse_word, words__6871);
  return cljs.core.PersistentVector.fromArray([parsed__6873, comment__6872], true)
};
gsim.parse.parse = function parse(gcode_str) {
  var lines__6875 = clojure.string.split.call(null, gcode_str, /\r|\n|\r\n/);
  return cljs.core.map.call(null, gsim.parse.parse_block, lines__6875)
};
